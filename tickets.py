...
#: Сколько тикетов в сутки может завести один человек. Не от жадности:
#: десять одинаковых обращений подряд владелец всё равно не разберёт, а
#: список превратится в кашу.
DAILY_LIMIT = 5
