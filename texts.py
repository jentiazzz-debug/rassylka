...
def start(name: str | None, subscription: db.Subscription) -> str:
    ...
    return (
        ...
        "своего имени по группам и чатам, где этот аккаунт уже "
        "состоит.\n\n"
        "В личные сообщения бот не пишет — ни вашим контактам, ни "
        "кому-либо ещё. Именно за рассылку в личку Telegram блокирует "
        "аккаунты быстрее всего.\n\n"
